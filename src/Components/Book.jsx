...
const Book = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-black text-white px-4 pt-10">
            <div className="w-full max-w-4xl bg-gray-800 p-6 shadow-lg space-y-6 rounded-lg">
